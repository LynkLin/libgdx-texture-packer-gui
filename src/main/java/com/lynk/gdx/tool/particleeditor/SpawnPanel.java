...
package com.lynk.gdx.tool.particleeditor;
...
class SpawnPanel extends EditorPanel {
	...
	JComboBox<SpawnShape> shapeCombo;
	JCheckBox edgesCheckbox;
	JLabel edgesLabel;
	JComboBox<SpawnShape> sideCombo;
	JLabel sideLabel;
	...
	private void initializeComponents () {
		...
		{
			shapeCombo = new JComboBox<SpawnShape>();
			shapeCombo.setModel(new DefaultComboBoxModel<SpawnShape>(SpawnShape.values()));
		...
		{
			sideCombo = new JComboBox<SpawnShape>();

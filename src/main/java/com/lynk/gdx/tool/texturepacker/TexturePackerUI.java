...
public class TexturePackerUI extends JFrame {
	...
	private JComboBox<Format> uiFormat;
	...
	public TexturePackerUI () {
		setIconImage(Toolkit.getDefaultToolkit().getImage(TexturePackerUI.class.getResource("/icon/pack.png")));
		initComponents();
		initListeners();
		updateUiState();
	}
	...
	private void initComponents() {
		...
		getContentPane().setLayout(new BorderLayout(0, 0));
		{
			...
			getContentPane().add(toolBar, BorderLayout.NORTH);
			{
				...
				uiNew.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/add.png")));
			...
			toolBar.addSeparator();
			{
				...
				uiDelete.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/delete.png")));
			...
			toolBar.addSeparator();
			{
				...
				uiRename.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/rename.png")));
			...
			toolBar.addSeparator();
			{
				...
				uiOpen.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/open.png")));
			...
			toolBar.addSeparator();
			{
				...
				uiSave.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/save.png")));
			...
			getContentPane().add(centerPanel, BorderLayout.CENTER);
			{
				...
				panel.setLayout(new MigLayout("insets 0", "[grow]", "[][grow]"));
				{
					...
					panel.add(buttonPane, "cell 0 0,grow");
					{
						...
						uiPackSelected.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/pack.png")));
					...
					}
					{
						...
						uiPackAll.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/pack.png")));
						...
						}
						{
							...
							scalePanel.setLayout(new BorderLayout(0, 0));
							{
								...
								scalePanel.add(toolBar, BorderLayout.NORTH);
								{
									...
									uiAddScale.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/add.png")));
								...
								toolBar.addSeparator();
								{
									...
									uiDeleteScale.setIcon(new ImageIcon(TexturePackerUI.class.getResource("/icon/delete.png")));
			...
			}
			{
				...
				}
				{
					...
					rightPanel.add(scrollPane, "cell 0 1,grow");
					{
						...
						{
							uiFormat = new JComboBox<Format>(new DefaultComboBoxModel<Format>(Format.values()));
						...
						{
							uiOutputFormat = new JComboBox<String>(new DefaultComboBoxModel<String>(new String[]{"png", "jpg"}));
						...
						{
							uiFilterMin = new JComboBox<TextureFilter>(new DefaultComboBoxModel<TextureFilter>(TextureFilter.values()));
						...
						{
							uiWrapX = new JComboBox<TextureWrap>(new DefaultComboBoxModel<TextureWrap>(TextureWrap.values()));
						...
						{
							uiFilterMag = new JComboBox<TextureFilter>(new DefaultComboBoxModel<TextureFilter>(TextureFilter.values()));
						...
						{
							uiWrapY = new JComboBox<TextureWrap>(new DefaultComboBoxModel<TextureWrap>(TextureWrap.values()));
	...
	private Pack packFromFile(File file) {
		...
		try {
			...
			settings.format = Format.valueOf(prop.getProperty("format", "RGBA8888"));
